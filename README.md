...
![создание секретных ключей LOGIN и KEY для GitHub Actions](https://github.com/nakigoe/hh-raise-bot/github-secrets.png "создание секретных ключей LOGIN и KEY для GitHub Actions")
