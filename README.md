...
![создание секретных ключей LOGIN и KEY для GitHub Actions](https://github.com/nakigoe/hh-ru-raise-bot/blob/main/github-secrets.png "создание секретных ключей LOGIN и KEY для GitHub Actions")
